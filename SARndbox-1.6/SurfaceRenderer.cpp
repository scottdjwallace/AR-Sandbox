...
SurfaceRenderer::SurfaceRenderer(const unsigned int sSize[2],const SurfaceRenderer::PTransform& sDepthProjection,const SurfaceRenderer::Plane& sBasePlane)
	...
	std::string str("../share/SARndbox-1.6/Shaders/SurfaceAddWaterColor.fs");
	...
	fileMonitor.addPath(str.c_str(),IO::FileMonitor::Modified,Misc::createFunctionCall(this,&SurfaceRenderer::shaderSourceFileChanged));
