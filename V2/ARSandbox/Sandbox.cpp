...
Sandbox::WaterToolFactory* Sandbox::WaterTool::initClass(Vrui::ToolManager& toolManager)
	...
	factory->setNumButtons(10);
	factory->setButtonFunction(0,"Dry");
	factory->setButtonFunction(1,"Flood");
	factory->setButtonFunction(2,"Drain");
	factory->setButtonFunction(3,"Water");
	factory->setButtonFunction(4,"Lava");
	factory->setButtonFunction(5,"Ice");
	factory->setButtonFunction(6,"Snow");
	factory->setButtonFunction(7,"Toxic");
	factory->setButtonFunction(8,"Melting");
	factory->setButtonFunction(9,"Volcano");
...
void Sandbox::WaterTool::buttonCallback(int buttonSlotIndex,Vrui::InputDevice::ButtonCallbackData* cbData)
	...
	if(buttonSlotIndex==9) { // Volcano
		application->currentMode=9;
		application->waterSpeed=1.0;
	}
}
